...
/**
 * Ответ — один JSON. Запас нужен щедрый: кроме чисел там вывод, объяснение
 * вердикта, объяснение риска измены, три текста портрета, пять идей для
 * свиданий и тройка «фильм, мем, мультфильм». Обрезанный ответ теряется
 * целиком — разбор JSON без закрывающей скобки не проходит и отчёт уходит
 * на формулы.
 */
